        ...
        <tbody>
            <tr>
                <td align="center" valign="top" style=""> 
                    <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:#87ceeb;border-radius:10px!important; overflow: hidden;">
                        <tbody>
                            <tr>
                                <td>
                                            ...
                                            <table border="0" cellpadding="20" cellspacing="0" width="100%" style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        <div align="center"><strong><h2 style="color: #000; font-size: 20px;line-height: 100%;">Reset Your {{ env('APP_NAME') }} Password</h2></strong></div>
                                                        <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            <h4 style="font-weight: 600; font-size: 18px; color: #000;">Hello,</h4>
                                                            ...
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #F7D047; text-align: left;">
                                                                <strong><a style="text-decoration: none;color: #2C93FA;" href="{{$link}}" target="_blank" rel="noopener noreferrer">Reset your password</a></strong>
                                                                </p>
                                                        </div>
                                                    </td>
                                                </tr>

                                                ...
                                                <tr>
                                                    <td>
                                                       <img src="{{ asset('') }}admin-assets/assets/img/logo.png" alt="" style="max-width: 190px; margin-bottom: 0px; ">
                                                        <h2 style="color: #ffffff; font-size: 30px;line-height: 100%;">New Service Order Placed </h2>
                                                    </td>
                                                    ...
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#000000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            ...
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000000; text-align: left;">
                                                                Order ID <strong>{{$o_data->order_no}}</strong> Placed Successfully
                                                            <table width="100%">
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>Total</td>
                                                                    <td>{{$o_data->total}} AED </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>VAT</td>
                                                                    <td>{{$o_data->vat}} AED </td>
                                                                </tr>
                                                                @if(!empty($o_data->discount))
                                                                <tr>
                                                                    <td>Discount</td>
                                                                    <td>{{$o_data->discount}} AED </td>
                                                                </tr>
                                                                @endif
                                                                <tr>
                                                                    <td>Grand Total</td>
                                                                    <td>{{$o_data->grand_total}} AED </td>
                                                                </tr>
                                                                <tr>

                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2 style="color: #ffffff; font-size: 30px;line-height: 100%;">Service Order {{$status}} </h2>
                                                    </td>
                                                    ...
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#000000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            ...
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000000; text-align: left;">
                                                                Order ID <strong>{{$o_data->order_no}}</strong> {{$status}}
                                                            <table width="100%">
                                                                <tr>
                                                                ...
                                                                @if(!empty($vendor))
                                                                <tr>
                                                                    <td>Accepted vendor name</td>
                                                                    <td>{{$vendor->first_name}} {{$vendor->last_name}}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Contact</td>
                                                                    <td>{{$vendor->dial_code}} {{$vendor->phone}}</td>
                                                                </tr>
                                                                @endif
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>Total</td>
                                                                    <td>{{$value->hourly_rate * $value->qty}}  AED</td>
                                                                </tr>
                                                                @if($value->discount)
                                                                <tr>
                                                                    <td>Discount</td>
                                                                ...
                                                                <tr>
                                                                    <td>Grand Total</td>
                                                                    <td>{{(($value->hourly_rate * $value->qty) - $value->discount) +  $value->vat}}  AED</td>
                                                                </tr>
                                                                @endforeach

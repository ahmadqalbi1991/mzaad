                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 75%;" align="center">
                                                                ...
                                                                <h1 style="color: #fff; font-size: 25px; line-height: 26px; margin:30px 0 0 0;">Maintanence Request Placed Successfully!!
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                                                ...
                                                                                <p style="margin:0;padding:0;margin-bottom:5px;color:#000;font-weight:400;font-size:13px;line-height:1.6">Your Maintanence Request placed successfully.</p>

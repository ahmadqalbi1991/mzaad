...
@endif
    ...
    <style>
        ...
        #parsley-id-66, #parsley-id-60, #parsley-id-21, #parsley-id-50, #parsley-id-36{
            position: absolute;
            bottom: -20px;
        }
        .table td, .table th {
...
.select2-container--default .select2-selection--multiple{
        ...
        .form-group input[type="checkbox"] + label {
            ...
            .password-toggle button{
                ...
                <!--<div class="card p-4">-->
                    <form method="post" id="admin-form" action="{{ url('portal/vendors') }}" enctype="multipart/form-data"
                    ...
                    <div class="">
                            ...
                            <div class="d-flex align-items-center pl-1">
                                <div class="mr-3">
                                    <input type="checkbox" id="Pharmacy" name="type[]" value="1"  data-parsley-required-message="Check at least one Vendor Type" data-parsley-mincheck="1" data-parsley-errors-container="#checkbox-errors" @if($vendor->industry_type == 1 || $vendor->industry_type == 3) checked @endif> 
                                    <label for="Pharmacy">Pharmacy</label>
                                </div>
                                <div class="">
                                    <input type="checkbox" id="health-services" name="type[]" value="2" checked @if($vendor->industry_type == 2 || $vendor->industry_type == 3) checked @endif>
                            ...
                            <select class="form-control" name="activity_id" id="activity_id" required
                                            data-parsley-required-message="Select activity type" disabled>
                              <option value="">Select activity type</option>
                              @foreach ($activityTypes as $value)
                                                    <option value="{{ $value->id }}" {{!empty($datamain->activity_id) && $datamain->activity_id == $value->id ? 'selected' : null;}}>
                                                        {{ $value->name }}</option>
                                                @endforeach;
                            </select>
                        </div>
                                    <div class="col-md-12 col-xs-12 is_food {{$datamain->activity_id == 5 ? '':'d-none'}}" >
                                        <div class="row mt-4" style="padding: 0 15px; align-items: center;">
                                            <div class="col-lg-auto mb-3">
                                                ...
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="is_dinein"> Pick Up</label>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-auto mb-3">
                                            ...
                                            <div class="col-lg-4 mb-3 " >
                                                <div class="shown-on-click_button" style="display:{{$id && $datamain->is_delivery?'':'none';}};">
                                                        ...
                                                        <a href="{{url('portal/products')}}" class="btn btn-primary" style="padding: 8px 15px !important;font-size: 13px !important;">Add Dishes</a>
                                        ...
                                        <div class="col-lg-4 col-xs-12">
                                         ...
                                         <div class="col-lg-4 col-xs-12" style="display:none;">
                                            <div class="form-group">
                                <label>Vendor type<b class="text-danger">*</b></label>
                                ...
                                data-parsley-required-message="Select Store type" >
                                    ...
                                    @foreach ($storetype as $cnt)
                                        <option <?php if(!empty($vendor->store_type)) { ?>
                                             {{$vendor->store_type == $cnt->id ? 'selected' : '' }} <?php } ?> >
                                            {{ $cnt->name }}</option>
                                    @endforeach;
                                </select>
                            </div>
                                        ...
                                        <div class="col-lg-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" data-jqv-maxlength="100" name="first_name" value="{{empty($datamain->first_name) ? '': $datamain->first_name}}"  data-parsley-required-message="Enter First Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-xs-12">
                                            <div class="form-group">
                                                <label>Last Name <span style="color:red;">*<span></span></span></label>
                                                <input type="text" class="form-control" data-jqv-maxlength="100" name="last_name" value="{{empty($datamain->last_name) ? '': $datamain->last_name}}" data-parsley-required-message="Enter Last Name">
                                            </div>
                                        </div>
                            ...
                            data-parsley-required-message="Enter Email" autocomplete="off" readonly>
                                          ...
                                          <div class="col-lg-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control jqv-input" data-jqv-required="true" name="trade_licene_number" data-jqv-maxlength="100" value="{{empty($vendor->trade_license) ? '': $vendor->trade_license}}" data-parsley-required-message="Enter Trade Licence Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control flatpickr-input" data-date-format="yyyy-mm-dd" name="trade_licene_expiry" value="{{empty($vendor->trade_license_expiry) ? '': date('Y-m-d', strtotime($vendor->trade_license_expiry))}}" data-parsley-required-message="Enter Trade Licence Expiry" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" oninput="validateNumber(this);" name="delivery_charge" value="{{$datamain->delivery_charge??0}}" data-parsley-required-message="Enter Delivery charge" >
                                            </div>
                                        </div>
                                        @endif
                                    ...
                                    <div class="col-lg-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control w-100" id="password" name="password" data-jqv-maxlength="50" value="" data-parsley-pattern="(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}" data-parsley-pattern-message="Password must contain minimum 8 characters at least 1 alphabet, 1 number , 1 special character without #" data-parsley-minlength="8" autocomplete="off" @if(empty($id)) required data-parsley-required-message="Enter Password" @endif
                                            >
                                    ...
                                    <div class="col-lg-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group position-relative">
                                            <input type="password" class="form-control w-100" name="confirm_password" id="cpassword" data-jqv-maxlength="50" value="" data-parsley-minlength="8"
                                    ...
                                    <div class="col-lg-4 col-xs-12">
                                        <div class="phone_box">
                                            <div class="form-group phone_box_dial">
                                            <label>Code</label>
                                        ...
                                        <div class="form-group w-100">
                                            ...
                                            <input type="tel" class="form-control" name="phone" value="{{empty($datamain->phone) ? '': $datamain->phone}}" data-jqv-required="true" required data-parsley-required-message="Enter Phone number" data-parsley-type="digits" data-parsley-minlength="5"  data-parsley-maxlength="12" data-parsley-trigger="keyup">
                                        </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="6" id="description" name="description"  required data-parsley-required-message="Enter About" value="" 
                            ...
                            data-parsley-required-message="Enter IBAN">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-xs-12" style="display:none;">
                                            <div class="form-group">
                            ...
                            <input type="text" name="txt_location" id="txt_location" class="form-control autocomplete" placeholder="673C+VFH - Dubai - United Arab Emirates"  data-parsley-required-message="Enter Location" @if($id) value="{{empty($vendor->location) ? '': $vendor->location}}" @endif>
                        ...
                        <div class="form-group col-md-12 d-none">
                            <div id="map_canvas" style="height: 200px;width:100%;"></div>
                                ...
                                data-parsley-required-message="Select Country" data-role="country-change" id="country_id" data-input-state="city-state-id">
                                    <option value="">Select</option>
                                    @foreach ($countries as $cnt)
                             ...
                             <div class="form-group col-md-4">
                                    ...
                                    data-parsley-required-message="Enter Street Name/No">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-12" style="display:none;">
                                                            <label>Area <span style="color:red;">*<span></span></span></label>
                                                            <input type="text" class="form-control" name="area" value="{{empty($vendor->area) ? '': $vendor->street}}" data-jqv-maxlength="100"   data-parsley-required-message="Enter Area">
                                                        </div>     
                            ...
                            data-parsley-required-message="Logo is required" @endif data-parsley-imagedimensions="200x200" data-parsley-trigger="change"
>
                                            <p class="text-muted">Allowed Dim 200x200(px)</p>
                                                    ...
                                                    <div class="col-lg-4 col-xs-12 other_docs mt-3" id="certificate_product_registration_div" >
                                                <div class="form-group">
                            ...
                            <div class="card mt-4 weekly" style="border-radius: 5px; overflow: hidden;" >
                                            <div class="card-body">
                                                ...
                                                <table class="table table-condensed pl-2 mt-2 workinghours align-top d-flex" >
                                                        ...
                                                        @foreach($days as $key => $val)
                                                            ...
                                                            @endphp
                                                            <tr class="align-top">
                                                                <td class="align-top" style="max-width:150px; width:150px">
                                                                ...
                                                                @endphp
                                                                <td class="align-top" style="max-width:150px; width:150px; display:{{(!empty($timings) && !empty($timings['from_hours']) )?'':'none'}};">
                                                                    <div class="custom-checkbox" style="margin-top: 10px;">
                                                                ...
                                                                <td data-sec-name="{{ucfirst($val)}}" class="{{$key}}-from-div from-td align-top days-div" style="display:{{$style;}};">
                                                                    @if(!empty($timings['from_hours']))
                                                                        @foreach($timings['from_hours'] as $index=>$time_key)
                                                                        <input type="text"  class="time from_time form-control r-{{$index}}" data-parsley-required id="{{$key}}_from_grooming"  name="{{$key}}_from_grooming[]" value="{{$time_key}}"  placeholder="Start Time">
                                                                        @endforeach
                                                                    @else
                                                                    <input type="text"  class="time from_time form-control" data-parsley-required id="{{$key}}_from_grooming"  name="{{$key}}_from_grooming[]" value=""   placeholder="Start Time">
                                                                    @endif
                                                                </td>
                                                                <td data-sec-name="{{ucfirst($val)}}" class="{{$key}}-to-div to-td align-top days-div" style="display:{{$style;}};">
                                                                    @if(!empty($timings['to_hours']))
                                                                        @foreach($timings['to_hours'] as $index=> $time_key2)
                                                                            <input type="text" value="{{$time_key2}}"  class="time to_time form-control r-{{$index}}" data-parsley-required data-parsley-daterangevalidation{{$key}} data-parsley-daterangevalidation{{$key}}-requirement="#{{$key}}_from_grooming"  data-parsley-greater-than-message="End time should be after start time" name="{{$key}}_to_grooming[]"  placeholder="End Time">
                                                                        @endforeach
                                                                    @else
                                                                    <input type="text"   class="time to_time form-control" data-parsley-required data-parsley-daterangevalidation{{$key}} data-parsley-daterangevalidation{{$key}}-requirement="#{{$key}}_from_grooming"  data-parsley-greater-than-message="End time should be after start time" name="{{$key}}_to_grooming[]"  placeholder="End Time">
                                                                    @endif
                                                                </td>
                                                                <td data-sec-name="{{ucfirst($val)}}" class="{{$key}}-btn-div align-top" style="display:{{$style;}};">
                                                                    ...
                                                                    @endphp
                                                                    <button type="button" data-k="{{$key}}" data-rem="r-{{$i+1}}" style="padding:0 !important;" class="btn btn-danger rm-btn time_remove_btn_1">-</button>
                                                                    @php
                                                                    }
                                                                    @endphp
                                                                </td>
...
@section('script')
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvYQkf-70Ka1kpQnAy2DB2-KB36RqMF8o&v=weekly&libraries=places&callback=Function.prototype"></script>
        ...
        $('body').on('click','.time-add-btn',function(e){
            ...
            var from_html = `<input type="text"   class="time form-control from_time data-parsley-required rem-`+uniqueString+`"   name="`+key_val+`_from_grooming[]"   placeholder="Start Time">`;
            var to_html = `<input type="text"  class="time form-control to_time data-parsley-required rem-`+uniqueString+`"   name="`+key_val+`_to_grooming[]"   placeholder="End Time">`;
            ...
            $(document).on('click','.del-menu-img',function(){ 
                ...
                if(image!="") { 
                    $.ajax({
                        ...
                        url: '{{ url("portal/removevendorMenuImage")}}',
        ...
        var currentLat = <?php echo !empty($vendor->latitude) ? $vendor->latitude : 25.204819 ?>;
        var currentLong = <?php echo !empty($vendor->longitude) ? $vendor->longitude : 55.270931 ?>;
    ...
    updatepostition = function(position, movemarker) {
        ...
        $('body').on('submit', '#admin-form', function(e) {
            e.preventDefault();
            let continue_more = 1;
            jQuery('table.workinghours tr').each(function(index, currentElement) {
                if( jQuery(currentElement).find('.24_hour_open').prop("checked") == false ){
                        let fromArray = [];
                        let toArray   = [];
                        
                        let timeTd = jQuery(currentElement).find('.from-td');
                        let timeDiv = jQuery(timeTd).find(".time");
                        let section_name = $(timeTd).attr("data-sec-name");
                        jQuery(timeDiv).each(function(indexTime, currentTimeElement) {
                            fromArray.push(jQuery(currentTimeElement).val());
                        });

                        let timeTd2 = jQuery(currentElement).find('.to-td');
                        let timeDiv2 = jQuery(timeTd2).find(".time");
                        jQuery(timeDiv2).each(function(indexTime, currentTimeElement) {
                            toArray.push(jQuery(currentTimeElement).val());
                        });

                        console.log(fromArray);
                        console.log(toArray);

                        jQuery(fromArray).each(function(ind, val) {
                            if(ind==0){
                                
                            }else{
                                console.log(val);
                                jQuery(fromArray).each(function(ind2, val2) {
                                    console.log(ind,ind2);
                                    if(ind2 < ind){
                                        console.log(val2,toArray[ind2]);
                                        var startDate = new Date("November 13, 2013 " + val2);
                                        var endDate = new Date("November 13, 2013 " + toArray[ind2]);
                                        var fromDate = new Date("November 13, 2013 " + val);
                                        console.log(startDate.getTime(),endDate.getTime(),fromDate.getTime());
                                        if(fromDate.getTime() >=  startDate.getTime() && fromDate.getTime() <= endDate.getTime()){
                                            App.alert("Please check the time slots selected for "+section_name);
                                            continue_more=0;
                                            return false;
                                        }
                                    }
                ...
                //console.log(jQuery(currentElement).find('.from-td').val());
            });
...
$('body').on('click', '.week_days', function(e) {
    if(!$(this).is(':checked'))
    {
        ...
        $(this).closest('td').siblings().attr('required', 'required');
    }
    else
    {
        $(this).closest('td').siblings().show();
        $(this).closest('td').siblings().removeAttr('required');
    }
});
...
$("#is_dinein").on('click', function(e){
    if(!$(this).is(':checked'))
    {
        // $(this).closest('td').siblings().hide();
        $(".shown-on-click").hide();
        $(".shown-on-click").attr('required', 'required');
    }
    else
    {
        $(".shown-on-click").show();
        $(".shown-on-click").removeAttr('required');
    }
});

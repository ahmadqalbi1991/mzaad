...
<div class="form-row">
    ...
    <div class="col-lg-3 d-none">
        <div class="form-group profile-form">
            ...
            <input type="text" name="product_code" value="{{ $pr_code ?? '0000000000' }}" class="form-control" data-role="product_code"  {{ $readonly}} />
        </div>
    </div>
        ...
        <div class="form-group profile-form d-flex align-items-center">
            ...
            <div class="form-check">
                <label class="form-check-label">
                    ...
                    <input class="taxable" type="checkbox" name="taxablesingle" value="1" <?php echo ($taxable == 1 ? 'checked': 'checked') ?>  /> Yes
                </label>
            </div>
        ...
        <div class="col-lg-12">
            <div class="upload-product-img">
                ...
                <div id="product-simple-images" class="upload-img-product-items" data-variant-id="<?php echo $default_attribute_id ?>">
                    <?php if (! empty($product_simple_image) ): ?>
                        <?php foreach ($product_simple_image as $t_name): ?>
                            ...
                            <div class="uploaded-prev-imd">
                                ...
                                <div class="del-product-img" data-role="product-img-trash" role="button"  data-image-file="<?php echo $t_name ?>" <?php echo ($readonly ? 'data-disabled="1"' : '') ?>><i class="far fa-trash-alt"></i> Delete</div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                        ...
                        $imageList = explode(",",$product->image); ?>
                            @if(!empty($imageList)) 
                                @foreach ($imageList as $key => $value) 
                                    <div class="uploaded-prev-imd">
                                        <img src="{{get_uploaded_image_url(config('global.upload_path').config('global.product_image_upload_dir').$value)}}" width="100" height="100">
                    ...
                    <div class="uploaded-prev-imd" <?php echo ($readonly ? '' : '') ?>>

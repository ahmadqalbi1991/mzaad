                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-3 d-none">
                        <div class="form-group profile-form">
                            ...
                            <input type="text" name="product_variant_product_code[<?=$input_index?>]" value="{{ $t_variant_product_code ?? '0000000000000'}}" class="form-control multi-attr-required" <?php echo ($readonly ? 'readonly': '') ?> />
                        </div>
                    </div>
                                ...
                                <?php if (! empty($t_variant_images) ): ?>
                                    <?php foreach ($t_variant_images as $t_name): ?>
                                        ...
                                        <div class="uploaded-prev-imd">
                                            ...
                                            <div class="del-product-img" data-role="product-img-trash" role="button" data-image-file="{{$t_name}}" <?php echo ($readonly ? 'data-disabled="1"' : '') ?>><i class="far fa-trash-alt"></i> Delete</div>
                                        </div>
                                    <?php endforeach; ?>
                                <?php endif; ?>

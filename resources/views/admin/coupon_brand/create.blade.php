...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ url('admin/save_coupon_brand') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
						...
						<div class="col-md-6" style="display:none">
							<div class="form-group">
								<label>Brand Name Ar<b class="text-danger">*</b></label>
								<input type="text" name="name_ar" class="form-control" 
									data-parsley-required-message="Enter brand Arabic Name" value="{{ $name_ar }}">
							</div>
						</div>
                    <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="image" class="form-control" data-role="file-image" data-preview="image-preview" data-parsley-trigger="change"
                                    ...
                                    <br>
                                    <img id="image-preview" style="width:100px; height:auto;" class="img-responsive"
                                    @if ($image) src="{{ asset($image) }}"
                                    @else src="{{asset('storage/users/placeholder.png')}}" @endif>
                            </div>
                        </div>
                        <div class="col-md-6">
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = App.siteUrl('/admin/coupon_brand');
                                },1500);

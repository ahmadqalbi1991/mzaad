...
@section('content')
    <div class="card mb-5">
        <div class="card-header">
            <a href="{{ url('admin/service_category/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Service Category</a>
          <a href="{{ url('admin/service_category/sort') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-arrow-up-wide-short"></i> Sort</a>
        </div>
        <div class="card-body">

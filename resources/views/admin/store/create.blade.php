...
@section('content')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            data-parsley-required-message="Select Vendor">
                                ...
                                @foreach ($vendors as $vnd)
                                    <option @if($id) @if($store->vendor_id==$vnd->id) selected @endif @endif @if(!empty($vendorid)) @if($vendorid==$vnd->id) selected @endif @endif value="{{ $vnd->id }}">
                                        {{ $vnd->name }}</option>
                                @endforeach;
                            </select>
                        </div>
    ...
    data-parsley-maxlength="12" data-parsley-trigger="keyup" data-parsley-errors-container="#mob_err"  @if($id) value="{{$store->mobile}}" @endif>
                              </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="commission" data-parsley-trigger="keyup" min="0" max="99" data-parsley-type="number" class="form-control" required
                                data-parsley-required-message="Enter Commission"  @if($id) value="{{$store->commission}}" @endif>
                        </div>
                        </div>
                        <div class="row">
                        <?php
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img id="image-preview" style="width:109px; height:109px;" class="img-responsive" @if($id && $store->logo) src="{{ asset($store->logo) }}" @endif>
                            <br><br>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img id="image-preview-b" style="width:205px; height:109px;" class="img-responsive" @if($id  && $store->cover_image) src="{{ asset($store->cover_image) }}" @endif>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="license_doc" class="form-control" data-parsley-trigger="change"
                                ...
                                @if($id  && $store->license_doc) <a href="{{ asset($store->license_doc) }}" target="_blank" rel="noopener noreferrer">View Document</a> @endif
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="vat_cert_doc" class="form-control" data-parsley-trigger="change"
                                ...
                                @if($id  && $store->vat_cert_doc) <a href="{{ asset($store->vat_cert_doc) }}" target="_blank" rel="noopener noreferrer">View Document</a> @endif
                        </div>
                        ...
                        <div class="col-md-12 form-group  imgs-wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 img-wrap">
                                    ...
                                    <img style="width:205px; height:109px;" class="img-responsive" src="{{ asset($img->image) }}">
                                </div>
                                @endforeach

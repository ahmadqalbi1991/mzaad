...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="">
                <form method="post" id="admin-form" action="{{ url('admin/save_servicetype') }}" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" required
                                    data-parsley-required-message="Enter Service Type Name" value="{{ $name }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = App.siteUrl('/admin/servicetype');
                                },1500);
